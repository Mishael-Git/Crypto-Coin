  ...
  return (
    <Navbar expand="lg">
      ...
      <Nav className="ms-auto">
       <Nav.Link href="#features" > <p class="text-white px-4 hover:text-slate-500">Features </p></Nav.Link>
       <Nav.Link href="#market" > <p class="text-white px-4 hover:text-slate-500">Market </p></Nav.Link>
       <Nav.Link href="#blog" > <p class="text-white px-4 hover:text-slate-500">Blog </p></Nav.Link>
